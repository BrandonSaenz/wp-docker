...
<span class="author vcard"<?php if ( is_single() ) { echo ' itemprop="author" itemscope itemtype="https://schema.org/Person"><span itemprop="name" style="display: none;">'; } else { echo '><span>'; } ?><?php the_author_posts_link(); ?></span></span>
